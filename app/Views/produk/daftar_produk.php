                        ...
                        <li class="nav-item dropdown no-arrow">
                            ...
                            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="userDropdown">
                                ...
                                <a class="dropdown-item" href="<?= base_url('user/settings'); ?>">
                                    <i class="fas fa-fw fa-cog-alt mr-2 text-gray-400"></i>
                                    Settings
                                </a>
                            ...
                            <tbody>
                                ...
                                foreach ($produk as $produk_item) { ?>
                                    <tr>
                                        ...
                                        <td><?= $produk_item['description']; ?></td>
                                        <td>Rp.<?= number_format($produk_item['harga_produk'], 0, ',', '.'); ?></td>
                                        <td>
                                            <center>
                                                <img src="<?= base_url('uploads/' . $produk_item['photos_filenames']) ?>" class="card-img-top img-fluid rounded" alt="Gambar">
                                            </center>
                                        </td>
                                        <td style="width:20%;">
                                            <div class="btn-group">
