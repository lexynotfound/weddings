...
<body class="bg-white">
                ...
                <div class="col-md-5 col-lg-4 order-md-last sticky-top">
                    ...
                    <ul class="list-group mb-3">
                        ...
                        <li class="list-group-item d-flex justify-content-between bg-body-tertiary">
                            ...
                            <span id="total_harga" class="text-success">Rp.<?= number_format($reservation['harga_produk'], 0, ',', '.'); ?></span>
                        </li>
                                ...
                                <div class="border rounded-3 p-4 mt-3">
                                    ...
                                    <div class="avatar me-3">
                                        ...
                                        <label class="lg-label fw-bold">
                                            ...
                                            di note, ketika melakukan transfer dengan memasukkan nama package
                                            yang anda pilih <?= $reservation['nama_produk']; ?> dan Ketikkan TRX-4 Digit akhir dari kode uniknya 
                                            ini <?= $reservation['id_transaksi']; ?>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            const buttonElement = document.querySelector('strong[name="total_harga"]');
            const buttonElementss = document.querySelector('label[name="total_harga"]');
            const buttonElements = document.querySelector('span[id="total_harga"]');
            buttonElement.innerHTML = ` ${formattedDpAmount}`;
